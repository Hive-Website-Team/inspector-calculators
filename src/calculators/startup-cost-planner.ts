...
export const record: CalculatorRecord = {
  ...
  inputs: [
    ...
    { key: 'softwareCost', label: 'Inspection software', unit: '$/yr', default: 1308, min: 0, max: 20000, help: "Illustrative \u2014 Spectora billed monthly is $1,308/yr; published plans run from about $500 to $1,308. Compare them in the software cost calculator" },
  ...
  assumptions: [
    { text: "The default software cost is Spectora billed monthly \u2014 $109 a month, which its pricing page states as $1,308 over twelve months. It is one published plan used as a starting point, not the market rate: the plans priced in this site's software cost calculator run from $500 a year to $1,308, and Spectora's own annual prepay is $1,090. Replace it with the plan you actually intend to buy.",
