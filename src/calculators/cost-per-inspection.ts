...
export const record: CalculatorRecord = {
  ...
  assumptions: [
    { text: "The $6,000 default is an illustrative monthly total, not a sourced or surveyed figure. It stands in for every operating line added together — software, insurance \u00f7 12, vehicle, marketing, admin and any staff pay — and is meant to be replaced with your own. Report software is only one line inside it; it is priced by vendor in the home inspection software cost calculator.",
      source: { citation: 'Derived \u2014 illustrative default, not a published price', derivation: 'Nobody publishes a single monthly operating cost for a home inspection business, because the figure is the sum of one inspector\u2019s own lines rather than anything a vendor or association quotes. $6,000 a month is used as a round starting value that divides legibly at the default twenty inspections, giving $300 a job. Nothing in the output depends on the choice: cost per inspection is monthly costs \u00f7 inspections, and both are entered by the reader.' } },
  ],
  referenceTable: {
